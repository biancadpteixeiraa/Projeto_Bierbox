...
interface ModalProps {
  ...
  export default function ModalCancelarAssinatura({ isOpen, onClose, onConfirm}: ModalProps) {
    return (
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-[420px] sm:max-w-lg">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-8 sm:pb-4">
                ...
                • Sentiremos sua falta! Ao cancelar, sua assinatura continuará ativa até o fim do período já pago.
                </p>
                <p className="mt-2 sm:text-base text-sm text-gray-700 pb-4">
                • Após esse período, os benefícios da assinatura serão desativados automaticamente.
                </p>
              </div>
