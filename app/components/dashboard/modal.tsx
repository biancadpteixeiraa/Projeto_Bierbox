          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-[420px] sm:max-w-lg">
              ...
              <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:justify-center sm:px-6 sm:pb-6">
                <button
                  onClick={onConfirm}
                  className="cursor-pointer inline-flex w-full justify-center px-6 py-2 text-base font-semibold text-brown-tertiary shadow-sm hover:bg-blue-900 sm:w-auto sm:ml-18"
                >
                  Confirmar
                </button>
                <button
